...
var PayloadCreation = function () {
  ...
  _createClass(PayloadCreation, [{
    ...
    key: 'crowdsale',
    value: function crowdsale(ecosystem, propertyPricision, previousId, category, subcategory, name, url, data, propertyIdDesired, tokensPerUnit, deadline, earlyBonus, undefine, totalNumber) {
      return _axios2.default.post(this.restURL + 'payloadCreation/crowdsale/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + propertyIdDesired + '/' + tokensPerUnit + '/' + deadline + '/' + earlyBonus + '/' + undefine + '/' + totalNumber).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    key: 'fixed',
    value: function fixed(ecosystem, propertyPricision, previousId, category, subcategory, name, url, data, amount) {
      return _axios2.default.post(this.restURL + 'payloadCreation/fixed/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + amount).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    key: 'managed',
    value: function managed(ecosystem, propertyPricision, previousId, category, subcategory, name, url, data) {
      return _axios2.default.post(this.restURL + 'payloadCreation/managed/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
