...
var WormholeCash = function WormholeCash(config) {
  _classCallCheck(this, WormholeCash);
  ...
  this.Configuration = new _DataRetrieval2.default(this.restURL);

  this.BITBOX = new BITBOXCli();
};

exports.default = WormholeCash;