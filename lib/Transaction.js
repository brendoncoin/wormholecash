...
var Transaction = function () {
  ...
  _createClass(Transaction, [{
    ...
    key: 'crowdSale',
    value: function crowdSale(fromAddress, ecosystem, propertyPrecision, previousId, category, subcategory, name, url, data, propertyIdDesired, tokensPerUnit, deadline, earlyBonus, undefine, totalNumber) {
      return _axios2.default.post(this.restURL + 'transaction/crowdSale/' + fromAddress + '/' + ecosystem + '/' + propertyPrecision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + propertyIdDesired + '/' + tokensPerUnit + '/' + deadline + '/' + earlyBonus + '/' + undefine + '/' + totalNumber).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    key: 'fixed',
    value: function fixed(fromAddress, ecosystem, propertyPrecision, previousId, category, subcategory, name, url, data, totalNumber) {
      return _axios2.default.post(this.restURL + 'transaction/fixed/' + fromAddress + '/' + ecosystem + '/' + propertyPrecision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + totalNumber).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    key: 'managed',
    value: function managed(fromAddress, ecosystem, propertyPrecision, previousId, category, subcategory, name, url, data) {
      return _axios2.default.post(this.restURL + 'transaction/managed/' + fromAddress + '/' + ecosystem + '/' + propertyPrecision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
