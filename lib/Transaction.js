...
var Transaction = function () {
  ...
  _createClass(Transaction, [{
    ...
    value: function changeIssuer(fromAddress, toAddress, propertyId) {
      return _axios2.default.get(this.restURL + 'transaction/changeIssuer/' + fromAddress + '/' + toAddress + '/' + propertyId).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function closeCrowdSale(fromAddress, propertyId) {
      return _axios2.default.get(this.restURL + 'transaction/closeCrowdSale/' + fromAddress + '/' + propertyId).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function crowdSale(fromAddress, ecosystem, propertyPricision, previousId, category, subcategory, name, url, data, propertyIdDesired, tokensPerUnit, deadline, earlyBonus, undefine, totalNumber) {
      return _axios2.default.get(this.restURL + 'transaction/crowdSale/' + fromAddress + '/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + propertyIdDesired + '/' + tokensPerUnit + '/' + deadline + '/' + earlyBonus + '/' + undefine + '/' + totalNumber).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function fixed(fromAddress, ecosystem, propertyPricision, previousId, category, subcategory, name, url, data, totalNumber) {
      return _axios2.default.get(this.restURL + 'transaction/fixed/' + fromAddress + '/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data + '/' + totalNumber).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function managed(fromAddress, ecosystem, propertyPricision, previousId, category, subcategory, name, url, data) {
      return _axios2.default.get(this.restURL + 'transaction/managed/' + fromAddress + '/' + ecosystem + '/' + propertyPricision + '/' + previousId + '/' + category + '/' + subcategory + '/' + name + '/' + url + '/' + data).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function rawTx(fromAddress, rawTransaction) {
      return _axios2.default.get(this.restURL + 'transaction/rawTx/' + fromAddress + '/' + rawTransaction).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function revoke(fromAddress, propertyId, amount) {
      return _axios2.default.get(this.restURL + 'transaction/revoke/' + fromAddress + '/' + propertyId + '/' + amount).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function STO(fromAddress, propertyId, amount) {
      return _axios2.default.get(this.restURL + 'transaction/STO/' + fromAddress + '/' + propertyId + '/' + amount).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
